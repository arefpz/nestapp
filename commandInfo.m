...
info_Load_Channel_Location = ["A pop-up window will appear to select the file you want to be used to detect the channels' location.",...
    ' EEGLAB: "pop_chanedit" will be used to automatically detect the locations using the provided file and standard electrode profile available in EEGLAB.'];
