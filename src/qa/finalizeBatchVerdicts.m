...
% > 0. That keeps incidental metrics (e.g., pctOutlierTrials gets
% computed whenever maxSatChans is enabled because both share the SM
% helper) from silently driving the verdict.
FIELD_TO_PARAM = { ...
    'nFlatChans',       'maxFlatChans'; ...
    'nSatChans',        'maxSatChans'; ...
    'pctOutlierTrials', 'maxOutlierTrialPct'; ...
    'pctOutlierChans',  'maxOutlierChanPct'; ...
